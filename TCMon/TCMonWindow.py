...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionCOM1_2 = QAction(MainWindow)
        self.actionCOM1_2.setObjectName(u"actionCOM1_2")
        self.actionCOM2_2 = QAction(MainWindow)
        self.actionCOM2_2.setObjectName(u"actionCOM2_2")
        self.action1_s_2 = QAction(MainWindow)
        self.action1_s_2.setObjectName(u"action1_s_2")
        self.action2_s_2 = QAction(MainWindow)
        self.action2_s_2.setObjectName(u"action2_s_2")
        self.action3_s_2 = QAction(MainWindow)
        self.action3_s_2.setObjectName(u"action3_s_2")
        self.action4 = QAction(MainWindow)
        self.action4.setObjectName(u"action4")
        self.action5_s_2 = QAction(MainWindow)
        self.action5_s_2.setObjectName(u"action5_s_2")
        self.action6_s_2 = QAction(MainWindow)
        self.action6_s_2.setObjectName(u"action6_s_2")
        self.action7_s_2 = QAction(MainWindow)
        self.action7_s_2.setObjectName(u"action7_s_2")
        self.action8_s_2 = QAction(MainWindow)
        self.action8_s_2.setObjectName(u"action8_s_2")
        self.action9_s_2 = QAction(MainWindow)
        self.action9_s_2.setObjectName(u"action9_s_2")
        self.action10_s_2 = QAction(MainWindow)
        self.action10_s_2.setObjectName(u"action10_s_2")
        ...
        self.gridLayout_7.addWidget(self.comboTipoTermopar, 0, 1, 1, 1)
        ...
        self.menuPorta = QMenu(self.menuMenu)
        self.menuPorta.setObjectName(u"menuPorta")
        self.menuAmostragem = QMenu(self.menuMenu)
        self.menuAmostragem.setObjectName(u"menuAmostragem")
        ...
        self.menuMenu.addAction(self.menuPorta.menuAction())
        self.menuMenu.addAction(self.menuAmostragem.menuAction())
        self.menuPorta.addAction(self.actionCOM1_2)
        self.menuPorta.addAction(self.actionCOM2_2)
        self.menuAmostragem.addAction(self.action1_s_2)
        self.menuAmostragem.addAction(self.action2_s_2)
        self.menuAmostragem.addAction(self.action3_s_2)
        self.menuAmostragem.addAction(self.action4)
        self.menuAmostragem.addAction(self.action5_s_2)
        self.menuAmostragem.addAction(self.action6_s_2)
        self.menuAmostragem.addAction(self.action7_s_2)
        self.menuAmostragem.addAction(self.action8_s_2)
        self.menuAmostragem.addAction(self.action9_s_2)
        self.menuAmostragem.addAction(self.action10_s_2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionCOM1_2.setText(QCoreApplication.translate("MainWindow", u"COM1", None))
        self.actionCOM2_2.setText(QCoreApplication.translate("MainWindow", u"COM2", None))
        self.action1_s_2.setText(QCoreApplication.translate("MainWindow", u"1 s", None))
        self.action2_s_2.setText(QCoreApplication.translate("MainWindow", u"2 s", None))
        self.action3_s_2.setText(QCoreApplication.translate("MainWindow", u"3 s", None))
        self.action4.setText(QCoreApplication.translate("MainWindow", u"4 s", None))
        self.action5_s_2.setText(QCoreApplication.translate("MainWindow", u"5 s", None))
        self.action6_s_2.setText(QCoreApplication.translate("MainWindow", u"6 s", None))
        self.action7_s_2.setText(QCoreApplication.translate("MainWindow", u"7 s", None))
        self.action8_s_2.setText(QCoreApplication.translate("MainWindow", u"8 s", None))
        self.action9_s_2.setText(QCoreApplication.translate("MainWindow", u"9 s", None))
        self.action10_s_2.setText(QCoreApplication.translate("MainWindow", u"10 s", None))
        ...
        self.comboTipoTermopar.setCurrentText(QCoreApplication.translate("MainWindow", u"T", None))
        ...
        self.menuPorta.setTitle(QCoreApplication.translate("MainWindow", u"Porta", None))
        self.menuAmostragem.setTitle(QCoreApplication.translate("MainWindow", u"Amostragem", None))
    # retranslateUi
